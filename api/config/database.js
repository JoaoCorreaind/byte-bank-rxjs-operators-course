...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'joao', 'joao@bytebank.com', '123', 'Joao' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'joao')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'vitor', 'vitor@bytebank.com', '123', 'Vitor' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'vitor')
`;
